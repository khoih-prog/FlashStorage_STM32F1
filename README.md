...
3. Install [**FlashStorage_STM32F1** library](https://platformio.org/lib/show/xxxxx/FlashStorage_STM32F1) by using [Library Manager](https://platformio.org/lib/show/xxxxx/FlashStorage_STM32F1/installation). Search for **FlashStorage_STM32F1** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
